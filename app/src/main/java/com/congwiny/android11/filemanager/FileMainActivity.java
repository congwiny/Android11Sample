package com.congwiny.android11.filemanager;
...
import com.congwiny.android11.R;
import com.congwiny.android11.filemanager.tools.FileSearcher;
import com.congwiny.android11.filemanager.tools.FileTools;
import com.congwiny.android11.filemanager.tools.UnitConversion;
...
public class FileMainActivity extends AppCompatActivity {
    ...
    private void suggestionInit() {
        ...
        suggestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FileMainActivity.this, Suggestion.class);
    ...
    private void infoButtonInit() {
        ...
        infoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FileMainActivity.this, InfoActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void categoryListInit() {
        ...
        final CategoryListAdapter categoryListAdapter = new CategoryListAdapter(FileMainActivity.this
        ...
        categoryList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case FileTools.MUSIC: {
                        Intent intent = new Intent(FileMainActivity.this, MusicActivity.class);
                        startActivity(intent);
                    }
                    break;
                    case FileTools.VIDEO: {
                        Intent intent = new Intent(FileMainActivity.this, VideoActivity.class);
                        startActivity(intent);
                    }
                    break;

                    case FileTools.DOCUMENT: {
                        Intent intent = new Intent(FileMainActivity.this, DocumentActivity.class);
                        startActivity(intent);
                    }
                    break;

                    case FileTools.IMAGE: {
                        Intent intent = new Intent(FileMainActivity.this, ImageActivity.class);
                        startActivity(intent);
                    }
                    break;

                    case FileTools.ALL_FILES: {
                        Intent intent = new Intent(FileMainActivity.this, AllFilesActivity.class);
                        startActivity(intent);
                    }
                    break;
